...
function hex( hexString ) {
	...
	const r = ( this.rgbaInt >> 24 & 0xFF ) / 0xFF,
	    g = ( this.rgbaInt >> 16 & 0xFF ) / 0xFF,
	    b = ( this.rgbaInt >> 8 & 0xFF ) / 0xFF,
	    a = ( this.rgbaInt & 0xFF ) / 0xFF;
...
export default class Color {
	constructor( color : Object | string ) {
	...
	get hex32() {
    const hex = this.rgbaInt.toString( 16 );
