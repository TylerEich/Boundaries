"use strict";
'use strict';
angular.module('boundaries', ['ngStorage', 'ui.map', 'ngAnimate', 'boundaries.color', 'boundaries.drawing', 'boundaries.geo', 'boundaries.image', 'boundaries.map', 'boundaries.mode', 'boundaries.search', 'boundaries.status']).directive('noScroll', function() {
  return {
    restrict: 'A',
