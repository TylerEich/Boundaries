...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">87.27% <small>(48 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">86.27% <small>(44 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
<span class="cline-any cline-yes">29792</span>
<span class="cline-any cline-yes">29792</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
transform._run = function (code, tree, opts) {
  traverse.replace(tree, function (node) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (node.type === "EmptyStatement") {
<span class="cstat-no" title="statement not covered" >      return traverse.Delete;</span>
    }
  });
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.sourceMap) {
<span class="cstat-no" title="statement not covered" >    genOpts.sourceMap = genOpts.file;</span>
<span class="cstat-no" title="statement not covered" >    genOpts.sourceContent = code;</span>
<span class="cstat-no" title="statement not covered" >    genOpts.sourceMapWithCode = true;</span>
  }
&nbsp;
  var result = util.generate(tree, genOpts);
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.sourceMap) {
<span class="cstat-no" title="statement not covered" >    if (opts.sourceMap === "inline") {</span>
<span class="cstat-no" title="statement not covered" >      result.code += "\n" + util.sourceMapToComment(result.map);</span>
    }
&nbsp;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu Oct 09 2014 15:39:21 GMT+1100 (AEDT)</div>
</div>
