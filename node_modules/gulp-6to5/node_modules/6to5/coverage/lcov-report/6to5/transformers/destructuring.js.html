...
var push = function (kind, nodes, pattern, parentId) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (pattern.type === "ArrayPattern") {
...
var pushArrayPattern = function (kind, nodes, pattern, parentId) {
  _.each(pattern.elements, function (elem, i) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!elem) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
