...
<html lang="en">
<head>
    <title>Code coverage report for 6to5/transformers/block-binding.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">6to5/transformers/block-binding.js</span></h1>
    <h2>
        
        Statements: <span class="metric">98.57% <small>(69 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">97.22% <small>(35 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">6to5/transformers/</a> &#187; block-binding.js</div>
</div>
<div class="body">
...
var buildForStatement = function (key) {
  return function (node, parent) {
    if (isLet(node[key])) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (parent.type === "LabeledStatement") {
<span class="cstat-no" title="statement not covered" >        throw util.errorWithNode(parent, "Label statements not supported with block binding yet.");</span>
      }
&nbsp;
